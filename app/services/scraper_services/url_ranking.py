...
class URLRanker:
    ...
    def rank_urls(self, urls: List[str], batch_size: int = 20) -> List[PageRanked]:
        ...
        for chunk in [urls[i:i + batch_size] for i in range(0, len_urls, batch_size)]:
            ...
            If the url contains words like "team", "people", "staff", "leadership", it is very likely to have information on the people that work there so give it a rating of 1.
